...
export default function App(props: any) {
  ...
  return (
    <Fragment>
      ...
      <svg>
        <symbol id="icon-checked" viewBox="0 0 20 20" fill="currentColor">
          <path
            fill-rule="evenodd"
  ...
  //           </div>
  //           <div className="lg:w-1/2 pl-5">
  //             <img src={Illus1} alt="Bring your model to life" />
  //           </div>
  //         </div>
  //       </div>
  //     </div>
  //     <section className="mx-auto max-w-4xl py-10">
  //       <h1 className="block text-blue-900 text-xl lg:text-3xl mx-auto font-bold tracking-wide text-center max-w-2xl">
  //         Built on H1stFlow Framework <br />
  //         Powered by Aitomatic H1stFlow Cloud Server
  //       </h1>
  //       <div className="mt-2 lg:mt-10">
  //         <div className="lg:flex items-center py-5">
  ...
  //               src={Illus2}
  //               className="mx-auto"
  //               alt="Built on H1stFlow Framework"
  //             />
  //           </div>
  //           <div className="lg:w-1/2 p-5 ">
  //             <h2 className="text-blue-800 mb-5 font-semibold text-2xl">
  ...
  //             </h2>
  //             <p className="text-gray-600 text-base">
  //               It takes just a few clicks to give your models a new home on our
  //               cloud
  //             </p>
  //           </div>
  //         </div>
  ...
  //             </h2>
  //             <p className="text-gray-600 text-base">
  //               We provide convenient ready-made UI widgets for different model
  //               types.
  //             </p>
  //           </div>
  //         </div>
  ...
  //             </h2>
  //             <p className="text-gray-600 text-base">
  //               Show them to friends and family, integrate them into apps with
  //               your co-workers, or link them to your porfolio.
  //             </p>
  //           </div>
  //         </div>
  //       </div>
