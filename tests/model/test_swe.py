...
from h1st.model.swe import SegmentedWorldEnsembleModeler, Segmentor, CombinationSegmentor
...
class TestSWE:
    ...
    def test_default_segmentor_and_ensemble(self):
        ...
        segmentation_features={
            'sepal_size': [('2020-01-01','2020-06-01'), ('2020-01-01','2020-06-01')], 
            'time': [()],
            'bb_size': None,
            'bb_aspect_ratio': None,
            'category_id': [['tuna'], ['yellowtail', 'makarel']] 
        }
        ...
        swe = swe_modeler.build_model(
            ...
            ensembler_modeler=RuleBasedModeler(model_class=MajorityVotingEnsemble)
        )
        pred = swe.predict(data['test_data'])['predictions']        
    ...
    def test_custom_segmentor_and_ensemble(self):
        ...
        swe = swe_modeler.build_model(
            ...
            sub_model_modeler=MySubModelModeler(),
            ensembler_modeler=RuleBasedModeler(model_class=MyRuleBasedEnsemble)
        )
        pred = swe.predict(data['test_data'])['predictions']
