...
class TestStackEnsemble:
    ...
    def test_train_predict(self):
        ...
        my_ml_modeler1.model_class = MyMLModel1

        my_ml_model1 = my_ml_modeler1.build_model(data)

        my_ml_modeler2 = MyMLModeler2()
        my_ml_modeler2.model_class = MyMLModel2
        ...
        with tempfile.TemporaryDirectory() as path:
            ...
            assert 'sklearn' in str(type(stack_ensemble_model_2.base_model))
